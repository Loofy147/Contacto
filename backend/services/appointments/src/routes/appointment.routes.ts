...
import { appointmentSchemas } from '../schemas/appointment.schemas';

const router = Router();
const controller = new AppointmentController();

router.post('/', authenticate, validate(appointmentSchemas.create), controller.create);
...
router.patch('/:id/cancel', authenticate, validate(appointmentSchemas.cancel), controller.cancel);
